		...
		if ($colors !== false) {
			...
			if (count($schemes) > 0) {
				...
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) {
						$colors = creditcard_get_scheme_colors($scheme);
					}
...
.minimal-light .esg-navigationbutton.esg-loadmore:before {
    color: {$colors['inverse_link']};
    background: {$colors['text_link']};
    background: -moz-linear-gradient(top left,{$colors['text_link']} 0%, {$colors['text_link2']} 100%);  /* FF3.6-15 */
    background: -webkit-linear-gradient(top left, {$colors['text_link']} 0%, {$colors['text_link2']} 100%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to bottom right,{$colors['text_link']} 0%, {$colors['text_link2']} 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
}
.minimal-light .esg-navigationbutton.esg-loadmore:after {
    color: {$colors['inverse_link']};
	background: {$colors['text_hover']};
    background: -moz-linear-gradient(top left,{$colors['text_hover']} 0%, {$colors['text_hover2']} 100%);  /* FF3.6-15 */
    background: -webkit-linear-gradient(top left, {$colors['text_hover']} 0%, {$colors['text_hover2']} 100%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to bottom right,{$colors['text_hover']} 0%, {$colors['text_hover2']} 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
  }
...
.sc_button_big_style_2:before {
    ...
    background: -moz-linear-gradient(top left,{$colors['alter_link2']} 0%, {$colors['alter_hover2']} 100%);  /* FF3.6-15 */
    background: -webkit-linear-gradient(top left, {$colors['alter_link2']} 0%, {$colors['alter_hover2']} 100%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to bottom right,{$colors['alter_link2']} 0%, {$colors['alter_hover2']} 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
 }
